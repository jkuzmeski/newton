...
def _validation_curves(manifest: Path, config: dict[str, Any], report: dict[str, Any], material: Material) -> list[dict[str, Any]]:
    base = manifest.parent
...
def identify_and_export(
    ...
    *,
    ...
    report_path = write_report(artifact_path, output / "validation_report.html")
