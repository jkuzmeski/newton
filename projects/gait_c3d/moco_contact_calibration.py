...
"""Deprecated redirect to :mod:`projects.gait_c3d.compatibility.moco_contact_calibration`."""
...
_REPLACEMENT = "projects.gait_c3d.compatibility.moco_contact_calibration"
