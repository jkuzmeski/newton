...
"""Deprecated redirect to :mod:`projects.gait_c3d.adapters.prepare_newton_contact_input`."""
...
_REPLACEMENT = "projects.gait_c3d.adapters.prepare_newton_contact_input"
