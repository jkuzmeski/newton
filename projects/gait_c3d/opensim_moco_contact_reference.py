...
"""Deprecated redirect to :mod:`projects.gait_c3d.oracles.opensim_moco_contact_reference`."""
...
_REPLACEMENT = "projects.gait_c3d.oracles.opensim_moco_contact_reference"
