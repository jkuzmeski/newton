...
"""Deprecated redirect to :mod:`projects.gait_c3d.compatibility.measured_load_diagnostics`."""
...
_REPLACEMENT = "projects.gait_c3d.compatibility.measured_load_diagnostics"
