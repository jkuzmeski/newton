...
from .example import (
    _advance_index as _advance_sample_index,
)
...
def _momentum_checkpoints(times: np.ndarray, velocity: np.ndarray, loaded: np.ndarray) -> list[float]:
    ...
    Use the shared reduction with this module's current checkpoint fractions.
    ...
    """
    return _utils.momentum_checkpoints(times, velocity, loaded, CHECKPOINTS)
